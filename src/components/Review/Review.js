...
const Review = () => {
  ...
  return (
    <div className="review pt-[62px]" ref={pageRef}>  
      ...
      {!isDoctor && <div className="w-[27%] m-auto h-[60px] rounded-full bg-[var(--greenLigth-color)] border border-[var(--greenLigth-color)] mt-10 flex justify-center items-center">
