...
const Dating = () => {
  ...
  return (
    <div className="pt-[62px] py-20 features" ref={pageRef}>
      ...
      <div class="container">
        <div class="feat" onClick={() => nav("/Aafia/DoctorsAppointment/Cardiology")}>
        ...
        <div class="feat" onClick={() => nav("/Aafia/DoctorsAppointment/Ophthalmology")}>
        ...
        <div class="feat" onClick={() => nav("/Aafia/DoctorsAppointment/Gastroenterology")}>
        ...
        <div class="feat" onClick={() => nav("/Aafia/DoctorsAppointment/Neurology")}>
        ...
        <div class="feat" onClick={() => nav("/Aafia/DoctorsAppointment/Gynecology")}>
        ...
        <div class="feat" onClick={() => nav("/Aafia/DoctorsAppointment/Orthopedics")}>
        ...
        <div class="feat" onClick={() => nav("/Aafia/DoctorsAppointment/Pediatrics")}>
        ...
        <div class="feat" onClick={() => nav("/Aafia/DoctorsAppointment/Psychiatry")}>
        ...
        <div class="feat" onClick={() => nav("/Aafia/DoctorsAppointment/General")}>
