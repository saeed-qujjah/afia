  ...
  return (
    <div className="py-20 features">
      ...
      <div class="container">
        ...
        <div class="feat" onClick={() => showFormHandler("Ophthalmology")}>
        ...
        <div class="feat" onClick={() => showFormHandler("Gastroenterology")}>
        ...
        <div class="feat" onClick={() => showFormHandler("Neurology")}>
        ...
        <div class="feat" onClick={() => showFormHandler("Gynecology")}>
        ...
        <div class="feat" onClick={() => showFormHandler("Orthopedics")}>
        ...
        <div class="feat" onClick={() => showFormHandler("Pediatrics")}>
        ...
        <div class="feat" onClick={() => showFormHandler("Psychiatry")}>
        ...
        <div class="feat" onClick={() => showFormHandler("General")}>
